...
public class BeamsService {
	...
	//brand -CRUD
	public static void notExistBrand(String Brdcode, String procode) throws NotExistException, SQLException{
		BrandDTO brand = BrandDAO.getBrand(Brdcode, procode);
		if(brand == null){
	...
	//브랜드 삭제
	public boolean deleteBrand(String Brdcode, String procode) throws SQLException, NotExistException{
		notExistBrand(Brdcode, procode);
		return BrandDAO.deleteBrand(Brdcode);
	}
	//브랜드 id로 검색
	public static BrandDTO getBrand(String Brdcode, String procode) throws SQLException, NotExistException{
		BrandDTO brand = BrandDAO.getBrand(Brdcode, procode);
		if(brand == null){
			throw new NotExistException("검색하신 브랜드 정보가 없습니다.");
		}
